...
const Header = () => {
  return (
    ...
    >
      ...
      <div className="flex">
        <button className="px-36 py-3 rounded-full bg-green-600 z-10 font-bold">
          Connect
        </button>
      </div>
      <div className="flex flex-col justify-center pt-10 ">
        ...
        <div className="z-10">
          <div className="col-start-3 col-end-5 z-10">
            <h5>
              <a href="https://git.io/typing-svg">
                <img
                  src="https://readme-typing-svg.herokuapp.com?font=Poppins&weight=700&size=30&duration=4000&pause=1000&color=FFFFFF&width=1000&height=100&lines=Hello+There+I'm+Rubuto+Yvan;I'+m+a+FullStack+Developer"
                  alt="Typing SVG"
                />
              </a>
            </h5>
          ...
          <div className="col-start-5 col-end-7 z-20">
            <div className="absolute bg-green-400 w-80 h-80 right-80 z-0 !important"></div>
            <div className=""></div>
            <div className="w-80 h-80 overflow-hidden rounded-2xl z-20">
